...
function Tabela({ dados, onDeletar, onVerDetalhes, carregando, carregandoMais, onCarregarMais, temMais }) {
  ...
  if (dados.length === 0) {
    return (
      <div className="vazio">
        ...
        <p>Adicione registros manualmente pela aba <strong>"Novo registro"</strong>.</p>
      </div>
    );
  }
    ...
    <div className="tabela-container">
      ...
      {temMais && (
        <div className="paginacao">
          ...
          >
            {carregandoMais ? 'Carregando...' : `Mostrar mais ${50}`}
          </button>
        </div>
      )}
    </div>
